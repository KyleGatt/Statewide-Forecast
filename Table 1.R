...
Table1[10,5]<- 36330000 ##available commercial harvest of sockeye taken from the ADFG forecast document




### Westward Region
# Note: These values should be double checked against the table westward provided prior to publication
...
footnote( i = 12, 
          j = 7,
            value = as_paragraph("Includes common property plus cost-recovery harvests."),
            ref_symbols = c("j"),                     
            part = "body")%>%
...
footnote( i = 15, 
          j = 5,
          value = as_paragraph("5-year average harvest (2020–2024); includes formal forecasts for Bear River late run and Nelson River sockeye salmon stocks."),
          ref_symbols = c("l"),
          part = "body")%>%

footnote( i = 15, 
          j = 7,
          value = as_paragraph("South Peninsula pink salmon harvest projection is for the Post-June fishery."),
          ref_symbols = c("m"),
          part = "body")%>%
